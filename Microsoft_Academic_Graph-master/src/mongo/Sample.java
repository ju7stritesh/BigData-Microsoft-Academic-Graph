...
public class Sample {
	...
	// ssh connection info
	private static final String SSH_USER = "renudesh";
	private static final String SSH_PASSWORD = "us+here+we+come";
	...
	public static void main(String[] args) throws JSchException {
		...
		HashMap<Integer, Integer> map = YearWiseTrend("spin polarization");
